import { connect, JSONCodec, StringCodec } from "https://deno.land/x/nats/src/mod.ts";
...
async function httpRequest({ url }) {
    ...
    try {
        const [,ms] = await timeout(2000, fetch(url, { method: 'OPTIONS', headers: { "User-Agent": "ATScan Crawler", 'connection': 'keep-alive', keepalive: "timeout=5, max=1000" }}))
    } catch (e) {
        return { err: 'timeout' }
    }
